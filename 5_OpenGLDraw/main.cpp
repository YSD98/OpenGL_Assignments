...
void SetMVPMatrix()
{
//    cy::Matrix4f Projection = getProjectionMatrix();
//
...
void LoadModel()
{
    ...
    if(!teaPot.LoadFromFileObj("5_OpenGLDraw\\models\\teapot.obj"))
    {
...
int main()
{
    ...
    programID = LoadShaders("5_OpenGLDraw\\shaders\\VertexShader.vert", "5_OpenGLDraw\\shaders\\FragmentShader.frag");
    ...
    //Assign buffers for the triangle and vertices list.
//    glGenBuffers(1, &vertexBuffer);
//    glBindBuffer(GL_ARRAY_BUFFER, vertexBuffer);
